...
function exHanoi_1(start, aux, end, n) {
    if (n == 1)
        ...
        hanoi(end, aux, start, 6 * (n - 1));
        moves.push([aux, end]);
        hanoi(start, aux, end, 6 * (n - 1) + 1);
        hanoi(end, aux, start, 6 * (n - 1) + 2);
        moves.push([aux, end]);
        hanoi(start, aux, end, 6 * (n - 1) + 2);
    }
    return
}  
...
function exHanoiMy(A, B, C, D, n) {
    if (n == 1) {
        moves.push([A, B]);
        moves.push([B, C]);
    } else {
        exHanoiMy(A, B, C, D, n - 1);
        moves.push([A, B]);
        exHanoiMy(C, D, A, B, n - 1);
        moves.push([B, C]);
        exHanoiMy(A, D, C, B, n - 1);
    }
}
...
function exhanoi_5(A, B, C, D, n) {
    if (n == 1) {
        ...
        moves.push([C, B]);
        moves.push([B, A]);
        moves.push([B, C]);  // 1 to c 2 and 3 to a and ...
        moves.push([A, B]);
        moves.push([B, C]);
        moves.push([A, B]);
        moves.push([C, B]);
        ...
        moves.push([B, C]);
        moves.push([A, B]);
        moves.push([B, C]);  // 1 and 2 and 3 to c ...
        moves.push([D, A]);
        moves.push([D, C]);
        moves.push([C, B]);
        moves.push([D, C]);
        ...
        moves.push([A, D]);
        exHanoiMy(C, B, A, D, 6 * (n - 1) + 3);
        moves.push([D, C]);
        moves.push([B, C]);
        moves.push([C, D]);
        moves.push([B, C]);
        moves.push([D, C]);
        exHanoiMy(A, B, C, D, 6 * (n - 1) + 3);
    }
    return
